...
Object.defineProperty(exports, "__esModule", { value: true });
exports.allBooks = exports.allReaders = void 0;
exports.allReaders = [
...
var button = document.getElementById('readersButton');
rxjs_1.fromEvent(button, 'click')
    .subscribe(function (event) {
    console.log(event);
    var readersDiv = document.getElementById('readers');
    for (var _i = 0, allReaders_1 = data_1.allReaders; _i < allReaders_1.length; _i++) {
        var reader = allReaders_1[_i];
