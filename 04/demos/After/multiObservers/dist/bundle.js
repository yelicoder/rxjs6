...
var currentTime$ = new rxjs_1.Observable(function (subscriber) {
    var timeString = new Date().toLocaleTimeString();
    subscriber.next(timeString);
    subscriber.complete();
});
currentTime$.subscribe(function (currentTime) { return console.log("Observer 1: " + currentTime); });
setTimeout(function () {
    currentTime$.subscribe(function (currentTime) { return console.log("Observer 2: " + currentTime); });
}, 1000);
setTimeout(function () {
    currentTime$.subscribe(function (currentTime) { return console.log("Observer 3: " + currentTime); });
}, 2000);
//#endregion
