...
var timerSubscription = timer$.subscribe(function (value) { return timesDiv.innerHTML += new Date().toLocaleTimeString() + " (" + value + ") <br>"; }, null, function () { return console.log('All done!'); });
var timerConsoleSubscription = timer$.subscribe(function (value) { return console.log(new Date().toLocaleTimeString() + " (" + value + ")"); });
timerSubscription.add(timerConsoleSubscription);
rxjs_1.fromEvent(button, 'click')
    .subscribe(function (event) { return timerSubscription.unsubscribe(); });
//#endregion
